...
class ProjectContractsService extends AbstractService
{
    use Get {
    ...
    {
        return $this->endpoint . 'projects/' . $this->projectId . '/contracts';
    }
    ...
    public function delete(int $projectId, int $contractId): void
    {
        $this->projectId = $projectId;
        $this->traitDelete($contractId);
    }
}
